const contractAddress = "0x561e97c7df674ce4e9e3c0f6218b2534b6ecb2f9"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the Dope Dudes NFT Collection!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Dope Dudes NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
